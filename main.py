...
def send_rich_message(chat_id, content, ctx=None, reply_markup=None):
    ...
    try:
        ...
        # ⚠️ On garde une trace claire de la VRAIE raison Telegram (visible dans les logs du bot),
        # car sans ça un échec d'entités (gras/citation/lien) est invisible pour l'utilisateur :
        # le message part quand même, mais sans sa mise en forme.
